...
test("pizza checkbox is initialy uncheked", () => {
    render(<App />);
...
test("toppings list initially contains cheese", () => {
    render(<App />);
...
test("checkboxes become checked when the user clicks it", () => {
    render(<App />);
...
test("topping appear in topping list when checked", () => {
    render(<App />);
